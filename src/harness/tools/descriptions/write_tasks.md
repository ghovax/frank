...
Keep entries **short, factual, and tied to observable work**. Skip the list entirely for a request the next response can obviously finish. **A task list you don't maintain is worse than none** — once you create tasks, keep them reconciled to reality via **update_tasks**.
