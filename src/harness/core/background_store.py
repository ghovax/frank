...
The in-memory :class:`~harness.core.background.BackgroundJobs` remains the source
...
def background_database_path() -> Path:
    return harness_home_directory() / BACKGROUND_DATABASE_FILENAME
            ...
            with self._connect() as connection:
                connection.execute(
                    ...
                    INSERT OR REPLACE INTO background_jobs (
                        job_id, context_id, agent_name, kind, spec_json, tool_call_id,
