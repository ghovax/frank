...
def save(data: dict) -> None:
    """Write the document back, in the order it holds rather than alphabetically — a person reading their own file should meet the settings in the order they wrote them."""
    path = configuration_file_path()
...
def remove(data: dict, path: str) -> bool:
    """Drop a dotted path, and every object above it that the drop left empty."""
    parts = path.split(".")
