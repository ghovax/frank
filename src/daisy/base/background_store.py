...
The in-memory :class:`~daisy.runtime.background.BackgroundJobs` remains the source
...
class BackgroundJobStore:
    ...
    :class:`~daisy.daemon.persistence.turn_store.AppendOnlyTaskStore` (as a :class:`~daisy.protocol.turn_record.TurnRecord`
