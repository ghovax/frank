...
logger = logging.getLogger("daisy.prototype")
...
def _load_runtime() -> None:
    ...
    import daisy.worker.serve  # noqa: F401
    import daisy.worker.server  # noqa: F401
    ...
    def _become_session(self, assignment: dict, ready_read: int, ready_write: int) -> int:
        ...
        try:
            ...
            with contextlib.suppress(Exception):
                logging.getLogger("daisy.worker").exception("Session process could not start")
            return 1
