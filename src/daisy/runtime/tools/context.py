...
It stopped being merely untidy at :mod:`daisy.runtime.tools.dispatch`, where a `bash` call
...
:mod:`daisy.runtime.background` binds the active job runner exactly this way. The value is per
...
_current: contextvars.ContextVar[Optional[ToolContext]] = contextvars.ContextVar(
    "daisy_tool_context", default=None
)
