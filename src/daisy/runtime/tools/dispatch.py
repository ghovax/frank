...
class _ToolsMixin:
    ...
    def _outside_working_directory_reads(self, command: str, working_directory: str | None = None) -> list[str]:
        ...
        system now (see :mod:`daisy.base.confinement`); reads outside the workspace remain allowed
    ...
    async def _tool_search_code(
        ...
        from daisy.runtime.tools.code_search import search_code
    ...
    async def _tool_session(
        ...
        from daisy.runtime.tools import sessions
