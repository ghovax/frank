...
from daisy.runtime.tools.dispatch import (
    _ToolsMixin,
)

from daisy.runtime.turnloop import (
    _TurnLoopMixin,
)

from daisy.runtime.permissions import (
    _PermissionsMixin,
)
...
class AgentRuntime(_ToolsMixin, _PermissionsMixin, _CompactionMixin, _TurnLoopMixin):
    ...
    def abort(self) -> None:
        ...
        # which is a separate process ended with `daisy kill`, not by stopping this turn.
