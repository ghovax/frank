...
``find_one``/``find_many`` via :mod:`daisy.computer.retrieval`, and composes trusted actions over
them, run in a killable subprocess by :mod:`daisy.computer.control`. The web substrate lives in :mod:`daisy.computer.web` (Chrome over
