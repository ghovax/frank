...
from daisy.daemon.registry import EXITED, FAILED, SessionRecord, SessionRegistry
...
def _close_subscribers(session_id: str) -> None:
    ...
    Without it an `daisy attach` on a session that is killed — or that dies on its own — sits
