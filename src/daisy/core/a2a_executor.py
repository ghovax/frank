"""A2A server adapter for the daisy.
...
from daisy.core.tool_policy import PermissionMode
from daisy.core.turn_events import (
    Checkpoint,
    CompactionDone,
    CompactionStarted,
    DeniedInjection,
...
from daisy.core.agent_messages import AgentMessage
from daisy.core.annotation_stamping import annotation_image_blocks, normalize_annotation_payloads
from daisy.core.events import (
...
from daisy.core.turn_record import (
    AgentLane,
    PendingInteraction,
    ToolGate,
    TurnKind,
...
from daisy.core.a2a_files import FileUrlSigner, build_file_part, ingest_file_part
from daisy.core.message_content import content_block_identifier, content_block_metadata
from daisy.core.remote_agents import RemoteAgentManager
from daisy.core.session_workspaces import SessionWorkspace
from daisy.core.skills import Skill
...
def _daisy_metadata(message) -> dict:
...
def _daisy_metadata_envelope(fields: dict) -> dict:
...
async def _ingest_incoming_file_parts(message) -> list[dict]:
    ...
    for part in (message.parts or []):
        ...
        if isinstance(root, FilePart):
            attachment = await ingest_file_part(part, daisy_home_directory())
...
class DaisyAgentExecutor(AgentExecutor):
