...
from daisy.core.agent_internals import model_is_authorized
...
from daisy.core.turn_events import DelegateMessage
from daisy.core.turn_events import DelegateRelay
from daisy.core.turn_events import Relayed
    ...
    def _drain_agent_messages(self) -> bool:
        ...
        while not self._agent_messages.empty():
            ...
            self._conversation.append(
                self._daisy_note_message(self._prompt_loader.load(template_name, variables))
            )
