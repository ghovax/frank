...
from daisy.core.litellm_model import ChatLiteLLMModel
from daisy.core.codex_model import ChatCodexModel
from daisy.core.agent_messages import AgentMessage
from daisy.core.file_leases import FileLeaseManager
from daisy.core.models import find_model, resolve_litellm
...
from daisy.core.background import (
    BackgroundJobs,
...
from daisy.core.tool_policy import (
    CallExecutionPolicy,
    PermissionMode,
    ResolvedLocation,
    ToolLocationError,
...
from daisy.core.agent_tools import (
    _ToolsMixin,
)

from daisy.core.agent_delegation import (
    _DelegationMixin,
)

from daisy.core.agent_turnloop import (
    _TurnLoopMixin,
)

from daisy.core.agent_permissions import (
    _PermissionsMixin,
)

from daisy.core.agent_compaction import (
    _CompactionMixin,
)


from daisy.core.agent_internals import (
...
class AgentRuntime(_ToolsMixin, _PermissionsMixin, _CompactionMixin, _DelegationMixin, _TurnLoopMixin):
    ...
    def _background_result_events(self) -> list[TurnEvent]:
        ...
        for completion in self._background.drain_completed():
            ...
            # bust the whole prefix; see _daisy_note_message). Rewriting the
