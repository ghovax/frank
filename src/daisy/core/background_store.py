...
The in-memory :class:`~daisy.core.background.BackgroundJobs` remains the source
...
from daisy.core.sqlite_lock import background_sqlite_write_lock, configure_background_sqlite_lock
...
def background_database_path() -> Path:
    return daisy_home_directory() / BACKGROUND_DATABASE_FILENAME
...
class BackgroundJobStore:
    ...
    :class:`~daisy.core.task_store.AppendOnlyTaskStore` (as a :class:`~daisy.core.turn_record.TurnRecord`
