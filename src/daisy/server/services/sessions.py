...
from daisy.core.a2a_executor import DaisyAgentExecutor

from datetime import datetime
from datetime import timezone
from fastapi import HTTPException
from daisy.core.agent import build_chat_model
from daisy.core.agent import model_is_authorized
from daisy.core.configuration import PromptLoader
from daisy.core.configuration import load_agent_configuration
from daisy.core.session_workspaces import SessionWorkspace
from daisy.core.session_workspaces import WorkspaceStrategy
from daisy.core.sqlite_lock import sqlite_write_lock
from daisy.server.models import SessionTitle
...
from daisy.server.database import SessionLifecycleRecord, SessionRecord
...
def _claim_work_habits_acknowledgement(context_id: str) -> bool:
    ...
    with sqlite_write_lock():
        ...
        try:
            ...
            logging.getLogger("daisy.server").exception(
