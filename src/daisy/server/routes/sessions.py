...
from daisy.server.database import SessionRecord
from fastapi import Request
from daisy.core.configuration import daisy_home_directory
...
from daisy.server.services.artifacts import _prune_session_artifacts
from daisy.server.services.sessions import _abort_pending_input, _remove_upload_file, _session_draft, _sessions_payload, _update_session_draft
...
async def delete_session(context_id: str):
    ...
    if state._task_store is not None:
        uploads_root = str(daisy_home_directory() / "uploads")
