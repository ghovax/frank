...
from xeac.runtime.internals import _background_handle_kind
from xeac.runtime.internals import _cap_model_result_payload
from xeac.runtime.internals import _coerce_mcp_arguments
...
from xeac.runtime.tools.registry import call_mcp_tool_with_events
from xeac.runtime.tools.registry import list_mcp_resources as list_mcp_resources_tool
from xeac.runtime.tools.registry import list_mcp_tools as list_mcp_tools_tool
from xeac.runtime.tools.registry import read_mcp_resource as read_mcp_resource_tool
from xeac.runtime.tools.registry import search_web as search_web_tool
...
class _ToolsMixin:
    ...
    async def _tool_bash(
        ...
        if policy.is_remote:
            ...
            from xeac.locations.executor import SshExecutor
    ...
    async def _tool_search_code(
        ...
        from xeac.runtime.tools.code_search import search_code
    ...
    def _surface_for(surface_name: str):
        ...
        from xeac.computer import engine as native_surface, web as web_surface
    ...
    async def _tool_control_screen(
        ...
        from xeac.computer import control, retrieval
