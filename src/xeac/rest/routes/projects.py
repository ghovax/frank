...
from xeac.locations.resolver import host_is_defined
...
from xeac.daemon.services.projects import _create_location, _create_project, _delete_location, _delete_project, _hosts_payload, _project_name, _project_payload, _projects_payload, _update_location
