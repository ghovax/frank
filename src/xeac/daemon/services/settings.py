...
from xeac.daemon.services.sessions import _reset_work_habits_acknowledgements
...
async def _reload_configuration_from_disk() -> None:
    ...
    # than this one — the value is carried so `xeac configure` reports what is stored, not so the
