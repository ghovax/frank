"""The words the fork protocol uses, shared by the daemon, the prototype and the session."""
...
def describe(reason: str, detail: str = "") -> str:
    """A wire reason as a sentence, passing an unknown code through rather than swallowing it."""
    try:
