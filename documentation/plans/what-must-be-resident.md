...
| **`rest` drifts back into importing `daemon`** | It is the path of least resistance, and it is how the surface grew inside the daemon in the first place | The layering checker, with both exemptions removed (#30) |
