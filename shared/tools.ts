 ...
 */
function readFileLabel(filePath: string, args: Record<string, unknown>, t: Translate): string {
 ...
 */
function controlScreenLabel(args: Record<string, unknown> | undefined, t: Translate): string {
...
function fallbackLabel(name: string, args: Record<string, unknown> | undefined, t: Translate): string {
  switch (name) {
    case "search_web":
...
export function toolCallDisplay(
  ...
  const t = translate ?? labels("ToolDisplay");
