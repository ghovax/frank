...
// Whether a tool call declared that it changes nothing, and what reach it asked for beyond its sandbox.
...
// Always a value, never null, so a caller reads `.writes` without a guard on every line.
