...
// The workspace-environment manager inside Settings.
export function WorkspaceLocationsPanel({ workspaceId }: { workspaceId: string }) {
  ...
  useEffect(() => {
    ...
    // Only re-read hosts live — never clobber in-progress location edits from a workspaces_changed event (a save reloads explicitly).
