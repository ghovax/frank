...
# "Daisy" macOS Accessibility entry instead of showing a bare helper name.
#
...
"./packaging/dist/Daisy Computer Use.app/Contents/MacOS/daisy" daisyd >/tmp/daisy-daemon-smoke.log 2>&1 &
daemon_pid=$!
...
rm -rf web/src-tauri/server-bin/daisy "web/src-tauri/server-bin/Daisy Computer Use.app"
