...
export function Button({
  ...
  // Every variant carries a border; only its colour changes.
...
const styles = StyleSheet.create({
  ...
  // Clipped to the icon's box so the intrinsically larger indicator cannot change the row's height, and centred within it so it turns about the middle of the button.
