...
export default function MachinesScreen() {
  ...
  const open = (machine: Pairing) => {
    ...
    // Cleared on the way out rather than on arrival: the push is synchronous and the probe is not, so a spinner left running here would still be turning behind the screen on top of it.
        ...
        {machines.length === 0 ? (
          ...
          machines.map((machine) => (
            <Row
              ...
              title={machine.name}
              // The address, because it is what distinguishes two machines a person has given similar names, and because seeing it is how you notice you paired the wrong one.
